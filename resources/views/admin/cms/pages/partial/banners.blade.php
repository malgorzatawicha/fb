<div class="panel-heading">
    ...
    <h5>{{trans('admin.pages.banners.page_title')}}</h5>
</div>
<div class="panel-body">
                ...
                <div class="col-sm-3 thumb">
                    ...
                    <form action="{{route('admin.cms.pages.banners.destroy', ['page' => $page->slug, 'banner' => $banner->id]) }}" method="POST">
                        ...
                        <div class="btn-group btn-group-justified">
                            ...
                            <a class="btn btn-danger btn-sm" title="{{trans('admin.delete')}}" data-bannerid="{{$banner->getKey()}}" onclick="$(this).parent().parent().submit()">
    ...
    @else
        <p>{{trans('admin.pages.banners.no_records')}}</p>
    @endif
</div>
